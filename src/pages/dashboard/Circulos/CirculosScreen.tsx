...
import { ICirculos} from './interface';
import './styles/Circulos.scss';
import { useCirculos } from '../context/circulos.context'; 
import { useNotification } from '@/context/Notification/NotificationProvider';
import { useNavigate } from 'react-router-dom';
import { router } from '@/constants';

export interface CirculosInterface {}
...
const Circulos: React.FC<CirculosInterface> = () => {
  const circulosContext = useCirculos();
