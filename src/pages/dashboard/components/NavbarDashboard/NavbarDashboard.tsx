      ...
      <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
        <ul className="navbar-nav align-center gap-5">
          <li className="nav-item ">
            <NavLink className="nav-link link text-dark" to={router.NEW_SUBMISSION}>
            Nueva Solicitud
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link link text-dark " to={router.LISTADO}>
              Listado de planillas
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link link text-dark " to={router.ESTADISTICAS}>
             Estadisticas
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link link text-dark " to={router.CIRCULOS}>
              Circulos
            </NavLink>
          </li>
        </ul>
