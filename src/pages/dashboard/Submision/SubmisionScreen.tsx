...
const Submision: React.FC<SubmisionInterface> = () => {
  ...
  return (
    ...
    <div className="card-body col-12 submision container justify-content-between">
      <h2 className="text-center">Solicitud de Matricula de Circulo Infantil</h2>
      <Formik
        ...
        {({ values, handleSubmit, handleReset, isSubmitting }) => (
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex justify-content-center  gap-2 pb-3">
              ...
              <button type="button" className="btn btn-group btn-secondary  justify-content-center" onClick={handleReset}>
                <i className="ibtn bi bi-arrow-clockwise"></i>
              </button>

              <button type="button" className="btn btn-group btn-gray justify-content-center" onClick={() => navigate(router.DASHBOARD)}>
